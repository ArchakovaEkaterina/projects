...
def buyed_race_tickets_with_class(race_number, date_out, place_class):
    with sqlite3.connect("db.db") as conn:
        ...
        WHERE races.race_number="%s" AND races.date_out="%s" AND tickets.place_class="%s" """ % (race_number, date_out, place_class)
